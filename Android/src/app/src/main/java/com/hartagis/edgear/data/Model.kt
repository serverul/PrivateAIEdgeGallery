...
data class Model(
   ...
   * - `com.hartagis.edgear` for builds from the GitHub source.
   * - `com.hartagis.edgear` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.hartagis.edgear/files/my_model/local_dir/
   *
