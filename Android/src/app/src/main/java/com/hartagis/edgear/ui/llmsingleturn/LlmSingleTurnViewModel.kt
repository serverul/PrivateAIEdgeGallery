...
import com.hartagis.edgear.common.processLlmResponse
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == com.hartagis.edgear.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == com.hartagis.edgear.data.BuiltInTaskId.LLM_ASK_AUDIO
